...
for x in short_animal_tuple:
  if x == animal_types[6]:
    gnu_count += 1

print("Animal Count in Short Tuple")
print("Gnus = ", gnu_count)

gnu_count = 0

for x in medium_animal_tuple:
  if x == animal_types[6]:
    gnu_count += 1

print("Animal Count in Medium Tuple")
print("Gnus = ", gnu_count)
gnu_count = 0

for x in long_animal_tuple:
  if x == animal_types[6]:
    gnu_count += 1

print("Animal Count in Long Tuple")
print("Gnus = ", gnu_count)
...
for x in short_animal_tuple:
  if x == animal_types[0]:
     elephant_count += 1 
  elif x == animal_types[1]:
    rhinoceros_count +=1
  elif x == animal_types[2]:
    lion_count +=1
  elif x == animal_types[3]:
    water_count +=1
  elif x == animal_types[4]:
    leopard_count +=1
  elif x == animal_types[5]:
    giraffe_count +=1
  elif x == animal_types[6]:
    gnu_count +=1
  elif x == animal_types[7]:
    thompson_count +=1
  elif x == animal_types[8]:
    dik_count +=1
  elif x == animal_types[9]:
   zebra_count +=1
  elif x == animal_types[10]:
    baboon_count +=1
  elif x == animal_types[11]:
    hyena_count +=1
  elif x == animal_types[12]:
   hippo_count +=1
  elif x == animal_types[13]:
   corcodile_count +=1
  elif x == animal_types[14]:
   ostriuch_count +=1
  elif x == animal_types[15]:
   wilddog_count +=1
  elif x == animal_types[16]:
   warthog_count +=1
  elif x == animal_types[17]:
   vulture_count +=1
  
  counter1 += 1
print("Short list:")
print ("Elephant count",elephant_count)
print ("Rhino count",rhinoceros_count)
print ("lion_count",lion_count)
print ("water_count",water_count)
print ("leopard_count",leopard_count)
print ("giraffe_count",giraffe_count)
print ("gnu_count",gnu_count)
print ("thompson_count",thompson_count)
print ("dik_count",dik_count)
print ("zebra_count",zebra_count)
print ("baboon_count",baboon_count)
print ("hyena_count",hyena_count)
print ("hippo_count",hippo_count)
print ("corcodile_count",corcodile_count)
print ("ostriuch_count",ostriuch_count)
print ("wilddog_count",wilddog_count)
print ("warthog_count", warthog_count)
print ("vulture_count", vulture_count)
elephant_count = 0
rhinoceros_count = 0
lion_count = 0
water_count = 0
